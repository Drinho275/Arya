...
// recursos anime, random @nabuto domina vida
        ...
        case 'fotodrinho2':
				...
				case 'porno':
					...
					buffer = await getBuffer(`https://i.imgur.com/KxgFGDc.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '🥴'})
					buffer = await getBuffer(`https://i.imgur.com/yAO4TU2.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '😏'})
					buffer = await getBuffer(`https://i.imgur.com/YZ5IsJv.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'totosa'})
					buffer = await getBuffer(`https://i.imgur.com/FPc8wdP.jpg`)
